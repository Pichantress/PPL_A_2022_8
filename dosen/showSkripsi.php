<?php
    ...
    $query2 = "SELECT *, COUNT(*) AS belum_ambil
                ...
                INNER JOIN skripsi ON 
                mahasiswa.id_skripsi_fk = skripsi.id_skripsi
                WHERE dosen_wali = nama_dosen AND email_dosen='$email' AND angkatan='{$k}' AND status_skripsi='belum ambil'"
                ;
    ...
    $query3 = "SELECT *, COUNT(*) AS sedang_ambil
                ...
                INNER JOIN skripsi ON 
                mahasiswa.id_skripsi_fk = skripsi.id_skripsi
                WHERE dosen_wali = nama_dosen AND email_dosen='$email' AND angkatan='{$k}' AND status_skripsi='sedang ambil'"
                ;
    ...
    $query4 = "SELECT *, COUNT(*) AS lulus
                ...
                INNER JOIN skripsi ON 
                mahasiswa.id_skripsi_fk = skripsi.id_skripsi
                WHERE dosen_wali = nama_dosen AND email_dosen='$email' AND angkatan='{$k}' AND status_skripsi='lulus'"
                ;
