                            ...
                            <form action="" method="POST" autocomplete="on">
                                <table class="table table-striped" id="datatablesSimple">
                                        ...
                                        $query = "SELECT * FROM mahasiswa
                                                    INNER JOIN verifikasi ON
                                                    mahasiswa.nim = verifikasi.nim_verifikasi
                                                    INNER JOIN dosen ON
                                        ...
                                        while($data = mysqli_fetch_array($sql_ppl)){ ?>
                                            <tr>
                                                ...
                                                <td><?=$data['nama']?></td>
                                                <td><?=$data['angkatan']?></td>
                                                <td><?=$data['tipe_verifikasi']?></td>
                                                <td><?=$data['status_verifikasi']?></td>
                                                <td>
                                                    <a href=<?php echo '"get_verifikasi.php?nim='.$data['nim'].'&tipe_verifikasi='.$data['tipe_verifikasi'].'"'?> class="btn btn btn-success btn-lg px-5">Verification</a>
                                                </td>
