...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2022 at 10:52 AM
...
('KHS006', 3, 18, 48, 3.5, 3.5, '24060130432172', '');
...
--
ALTER TABLE `irs_seq`
  MODIFY `id_irs` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;
...
--
ALTER TABLE `khs_seq`
  MODIFY `id_khs` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `verifikasi`
  MODIFY `id_verifikasi` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
