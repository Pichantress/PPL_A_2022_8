...
if (isset($_POST["submit"])) {
    ...
    $transkrip    = $_FILES['upload_khs']['name'];
    $x        = explode('.', $transkrip);
    $ekstensi    = strtolower(end($x));
    $ukuran        = $_FILES['upload_khs']['size'];
    $file_tmp    = $_FILES['upload_khs']['tmp_name']; 
    ...
    if ($valid) {
        $query6 = "INSERT INTO `khs` (`nim_mahasiswa_fk`, `semester_aktif`, `jumlah_sks_semester`, `jumlah_sks_kumulatif`, `ip_semester`, `ip_kumulatif`, `dokumen`) VALUES ('$nim', '$status', '$jumlah_sks_semester', '$jumlah_sks_kumulatif', '$ip_semester', '$ip_kumulatif', '$transkrip');";
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form action="" method="POST" autocomplete="on" Enctype="Multipart/Form-Data">
                                        ...
                                        <br>
                                        <div class="form-group">
											<input type="file" name="upload_khs" accept=".pdf" class="form_control" />
                                        </div>
                                        <br />
                                        <div class="form-group">
