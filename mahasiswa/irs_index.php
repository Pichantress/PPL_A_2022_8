...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="container py-5 h-100">
                            ...
                            <div class="card-body">
                                ...
                                <select name="semester" id="semester" class="form-select" onchange="irs_semester(this.options[this.selectedIndex].value, '<?php echo $data['nim']?>')" style="width: 100px;">
                                ...
                                <br>
                                <a class="btn btn-warning btn-sm" href="entry_irs.php">Entry IRS</a>
                                    ...
                                    if (isset($_GET['semester'])){
                                        ...
                                        while($data = mysqli_fetch_array($sql_ppl)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="../assets/file/irs/<?php echo $data['dokumen'];?>"><?=$data['dokumen']?></td>
                                                <td><a class="btn btn-warning btn-sm" href=<?php echo '"update_irs.php?nim='.$nim.'&semester_aktif='.$semester.'"' ?>>Update IRS</a></td>
                                            </tr>
                                        <?php
                                        } ?>
        ...
        <script type="text/javascript">
            function irs_semester(value, nim){
                let url = "irs_index.php";
                window.location.href= url+"?semester="+value+"&nim="+nim;
            }
        </script>
    </body>
</html>
