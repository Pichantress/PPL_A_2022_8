                            ...
                            <div class="row d-flex justify-content-center align-items-center h-100">
                                <div class="col col-lg-9 col-xl-7">
                                    <div class="card bg-primary text-white mb-4">
                                            <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:350px;">
                                                <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                                    <img src="../assets/img/avatar.jpg"
                                                        alt="Generic placeholder image" class="img-fluid img-thumbnail mt-4 mb-2"
                                                        style="width: 150px; z-index: 1">
                                                        Status: <?=$data['status']?>
                                                        <a href=<?php echo '"edit_profile.php?nim='.$data['nim'].'"'?> class="btn btn-outline-warning" data-mdb-ripple-color="dark" style="z-index: 1;">Edit profile</a>

                                                </div>
                                                <div class="ms-3" style="margin-top: 50px;">
                                                    <h5>Nama Lengkap: <?=$data['nama']?></h5>
                                                    <p>
                                                        NIM: <?=$data['nim']?> <br>
                                                        Semester: <?=$data['semester']?><br/>
                                                        Angkatan: <?=$data['angkatan']?><br>
                                                        Jalur Masuk: <?=$data['jalur_masuk']?><br>
                                                        Dosen Wali: <?=$data['dosen_wali']?>
                                                    </p>
                                                    <p>
                                                        Email: <?=$data['email']?> <br>
                                                        No.HP: <?=$data['no_handphone']?> <br>
                                                ...
                                                <div class="ms-1" style="margin-top: 140px;">
